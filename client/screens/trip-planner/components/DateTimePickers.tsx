...
export function WebInputModal({ planner }: { planner: PlannerApi }) {
  const {
    showWebInput, setShowWebInput, formData, handleWebInputChange,
    generateDateOptions, generateTimeOptions, theme, t,
  } = planner;
...
export function NativePicker({ planner }: { planner: PlannerApi }) {
  const {
    pickerMode, setPickerMode, tempDate, confirmPicker, handlePickerChange, theme, t,
  } = planner;

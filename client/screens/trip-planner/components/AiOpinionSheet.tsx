...
export default function AiOpinionSheet({ planner }: { planner: PlannerApi }) {
  ...
  return (
    <SnapSheet
      visible={aiOpinionVisible}
      onClose={() => setAiOpinionVisible(false)}
      title={t("aiOpinion.title")}
    >
      {aiOpinionLoading ? (
        ...
        <Text
          style={[
            styles.aiOpinionLoadingText,
            { color: theme.textSecondary, padding: Spacing.lg },
          ]}
        >
          {aiOpinionError}
        </Text>
        ...
        >
          ...
          <View style={styles.aiOpinionSection}>
            <View style={styles.aiOpinionSectionHeader}>
              <Text
                style={[styles.aiOpinionSectionTitle, { color: theme.text }]}
              >
            ...
            <Text
              style={[styles.aiOpinionBody, { color: theme.textSecondary }]}
            >
              {aiOpinionData.feasibility?.reason}
            </Text>
          </View>
          <View
            style={[styles.aiOpinionDivider, { backgroundColor: theme.border }]}
          />
          ...
          <View style={styles.aiOpinionSection}>
            ...
            {(aiOpinionData.route_review?.issues || []).map(
            ...
            {(aiOpinionData.route_review?.optimization || []).map(
          ...
          <View style={styles.aiOpinionSection}>
            ...
            {(aiOpinionData.price_check?.daily || []).map(
              (d: any, idx: number) => (
                <View key={`day-${idx}`} style={styles.aiOpinionDayBlock}>
                  <Text
                    style={[styles.aiOpinionSubheading, { color: theme.text }]}
                  >
                    Day {d.day}
                  </Text>
                  <View style={styles.aiOpinionPriceRow}>
                    <Text
                      style={[
                        styles.aiOpinionBody,
                        { color: theme.textSecondary },
                      ]}
                    >
                      {t("aiOpinion.transport")}
                    </Text>
                    <Text style={[styles.aiOpinionBody, { color: theme.text }]}>
                      €{d.transport_eur}
                    </Text>
                  </View>
                  <View style={styles.aiOpinionPriceRow}>
            ...
            <View style={[styles.aiOpinionPriceRow, { marginTop: Spacing.sm }]}>
              ...
              <Text
                style={[styles.aiOpinionSectionTitle, { color: Brand.primary }]}
              >
          ...
          <Text
            style={[
              styles.aiOpinionEstimateNote,
              { color: theme.textTertiary, marginTop: Spacing.lg },
            ]}
          >

...
export const CITY_PREVIEW_MAP: Record<string, CityPreviewData> = {
  Paris: {
    ...
    highlights: ["에펠탑 야경 스팟", "루브르 박물관 패스트트랙", "몽마르트르 언덕 감성 카페"],
    days: "3일 2야 코스",
  ...
  Brussels: {
    ...
    highlights: ["그랑플라스 야경", "오줌싸개 소년 동상", "벨기에 수제 맥주 와플 투어"],
    days: "2일 1야 코스",
  ...
  Madrid: {
    ...
    highlights: ["마요르 광장 타파스 투어", "프라도 미술관 거장전", "마드리드 왕궁 산책"],
    days: "3일 2야 코스",
  ...
  Munich: {
    ...
    highlights: ["마리엔 광장 시계탑", "호프브로이하우스 생맥주", "신시청사 역사 동선"],
    days: "2일 2야 코스",
  ...
  London: {
    ...
    highlights: ["빅벤 & 국회의사당 스팟", "대영박물관 핵심 해설", "템스강 유람선 스카이라인"],
    days: "4일 3야 코스",
...
export default function RepresentativeTripShortForm({
  ...
  const preview = CITY_PREVIEW_MAP[cityName] || CITY_PREVIEW_MAP.Paris;
      ...
      <View style={styles.overlay}>
        <View style={styles.modalCard}>
          ...
          <View style={styles.imageContainer}>
            <Image source={{ uri: preview.imageUrl }} style={styles.cityImage} />
            <LinearGradient

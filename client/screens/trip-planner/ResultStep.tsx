...
export default function ResultStep({ planner }: { planner: PlannerApi }) {
  const {
    theme, insets, t, i18n, itinerary, setScreen,
    isSaving, justSaved, handleSaveItinerary,
    formData, dayAccommodations, hotelModalDay, setHotelModalDay, handleSetDayAccommodation,
    isReoptimizing, requestAiOpinion, requestExpert,
    resultScrollRef, slotLayoutsRef, dayLayoutsRef,

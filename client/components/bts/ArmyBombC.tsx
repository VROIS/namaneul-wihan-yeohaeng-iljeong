      ...
      <Defs>
        ...
        <RadialGradient id="headGlow" cx="50%" cy="45%" r="50%">
          <Stop
            offset="0%"
            stopColor="#FFFFFF"
            stopOpacity={0.15 + glowOpacity * 0.3}
          />
          <Stop
            offset="40%"
            stopColor={BORAHAE_LIGHT}
            stopOpacity={0.1 + glowOpacity * 0.2}
          />
...
function KakaoLogo() {
  return (
    <Svg width={22} height={22} viewBox="0 0 24 24">
      <Path
        d="M12 3C6.477 3 2 6.477 2 10.5c0 2.547 1.8 4.795 4.525 6.096l-.825 3.003c-.08.29.215.527.48.387l3.67-1.945c.37.045.755.069 1.15.069 5.523 0 10-3.477 10-7.61S17.523 3 12 3z"
        fill="#000000"
      />
    </Svg>
  );
...
function AppleLogo() {
  return (
    <Svg width={22} height={22} viewBox="0 0 24 24">
      <Path
        d="M17.05 20.28c-.98.95-2.05.88-3.08.42-1.09-.48-2.08-.48-3.24 0-1.44.62-2.2.44-3.06-.42C2.79 15.25 3.51 7.59 9.05 7.31c1.35.07 2.29.74 3.08.79 1.18-.24 2.31-.93 3.57-.84 1.51.12 2.65.72 3.4 1.8-3.12 1.87-2.38 5.98.48 7.13-.57 1.5-1.31 2.99-2.54 4.09zM12.03 7.25c-.15-2.23 1.66-4.07 3.74-4.25.29 2.58-2.34 4.5-3.74 4.25z"
        fill="#FFFFFF"
      />
    </Svg>
  );
...
export function ArmyBombC({
  ...
  return (
    <Animated.View
      style={[
        styles.container,
        { width: BOMB_WIDTH, height: TOTAL_H },
        containerStyle,
      ]}
    >
      {/* SVG 실루엣 배경 */}
      ...
      <View
        style={[
          styles.neckOverlay,
          { top: HEAD_SIZE - HEAD_SIZE * 0.1, width: NECK_WIDTH },
        ]}
      >
        <TextInput
      ...
      >
        ...
        <Pressable
          style={({ pressed }) => [
            styles.oauthBtn,
            styles.googleBtn,
            !birthComplete && styles.disabledBtn,

...
> **최종 업데이트: 2026-01-26 (일) 작업 후**
> **관련 문서**: [troubleshooting_video_generation_20260126.md](./troubleshooting_video_generation_20260126.md) - 비디오 생성 오류 상세 분석
...
| 2 | **여행 일정 데이터 복구** | ✅ | `docs/troubleshooting...` | API 누락 데이터(rawData) 12곳 복원 |

/**
 * ⚠️ 수정금지(승인필요) — 사용자 제공 원본 shadcn/ui 버튼 시스템 (2026-04-17 보관)
 *
 * 용도:
 *   - Next.js / React DOM / Tailwind 기반 웹 컴포넌트 원본 레퍼런스
 *   - 이 앱의 전역 버튼 시스템의 디자인 기준 (Button, LiquidButton, MetalButton)
 *
 * React Native 어댑트 버전:
 *   - client/components/ui/LiquidButton.tsx (SVG 필터/Tailwind/backdropFilter 불가 → BlurView + shadow로 시각 동등 재현)
 *
 * 원본 파일은 수정 금지.
 */

// 원본 보존용 = 손대지 마십시오(참고 전용, 앱에서 import 하지 않음).
// 출처 = https://21st.dev/@shuding/components/cobe-globe-labels
// 받은 날 = 2026-07-30 (사장님 제공)
//
// 실제 앱에서 쓰는 것 = client/components/ui/GlobeLabelsWeb.tsx
//   (이 원본을 우리 앱 규칙에 맞춰 옮긴 것: Tailwind 제거 · 좌표/라벨을 DB 에서 받도록 일반화)
//
// 이 파일을 남기는 이유 = 나중에 "원본이 어떻게 생겼었나" 를 대조하기 위함.
// Tailwind(className) 를 쓰므로 이 파일 그대로는 우리 앱에서 동작하지 않는다.

// ⚠️ 수정금지(승인필요) 2026-08-28 사장님 승인 = place_seed_raw.best_rank = 7자리 언어코드(분류번호) = 앱 전체 1벌(§16) · 쓰기 주체 = writeBestRankUnion() 1벌 = worker/lib/services/fill/gmaps-shared.ts(B2) · 쓰기 = 덮어쓰기가 아니라 자리별 합집합(∪) = bestRankUnion() 1벌.

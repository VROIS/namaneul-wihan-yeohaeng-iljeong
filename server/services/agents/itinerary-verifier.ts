...
export async function verifyItinerary(itinerary: any): Promise<VerifyResult> {
  ...
  const prompt = `You are reviewing a generated travel itinerary. With your basic knowledge, if you were making this trip yourself, would this itinerary be realistic?

Check:
1. Costs reasonable for the destination and style?
2. Route order logical (no unreasonable backtracking)?

...
3. narrationKo = 해당 슬롯의 summaryKo/editorialSummary 데이터만 근거로 작성(데이터에 없는 사실 창작 금지). 씬당 한국어 1문장, 6초 안에 낭독 가능한 길이(25자 내외), 유쾌한 구어체.
...
/** 씬 1개의 영상 생성 프롬프트 조립 = visualPrompt + 한국어 나레이션 오디오 지시 (단일 SSOT = 검증·본배선 공용) */
export function sceneClipPrompt(scene: GhibliScene): string {
